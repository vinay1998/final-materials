...
<%
	//jdbc logic section
		...
		out.print("<br/>");
		if(type.equals("pl"))
			out.print("<h3 align='center'><b>PERMISSION  LETTER</b></h3><br/><br/>");
		else if(type.equals("gp"))
			out.print("<h3 align='center'><b>GATE  PASS</b></h3><br/><br/>");
		...
		out.print("<b>"+student_details.getString(1)+"</b>.<br/><br/>");
		...
		<div class="center">
		&nbsp;&nbsp;&nbsp;&nbsp;
		<button type="submit" class="btn btn-success" value="grant" name="grant">Grant</button>&nbsp;&nbsp;
